...
gui.add(ambientLight,'intensity',0,1,.01).name('ambientLight Intensity')
scene.add(ambientLight)

const directionalLight = new THREE.DirectionalLight(0x050fffc,0.3);
directionalLight.position.set(1,0.25,0)
gui.add(directionalLight, 'intensity',0,1,.01).name('directionalLight Intensity')
...
const spotLight = new THREE.SpotLight(0x78ff00,.5,10, 200, 0,.5)
